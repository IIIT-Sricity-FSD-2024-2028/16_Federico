  ...
  if (window.SharedNav && typeof window.SharedNav.renderNavbar === 'function') {
    ...
    window.SharedNav.renderNavbar({
      ...
      links: [
        ...
        { href: 'screen-02-bed-management.html', label: 'Bed Management', module: 'ADMISSIONS' },
        { href: 'screen-03-patient-flow.html', label: 'Patient Flow', module: 'ADMISSIONS' },
        { href: 'screen-04-inventory.html', label: 'Inventory', module: 'INVENTORY' },
        { href: 'screen-05-billing.html', label: 'Billing', module: 'BILLING' },
      ],
    });
  }
});
