/**
 * marketplace-page.js — Organization Marketplace (tasks.md §4/§11).
 ...
 * with ?org=<id> so the chosen organization carries through (see
 * login-page.js / signup-page.js, which read that query param).
 */
(function () {
  ...
  function render() {
    ...
    filtered.forEach(function (org) {
      ...
      node.querySelector(".org-login-link").href = "../login/login-page.html?org=" + org.organization_id;
      node.querySelector(".org-register-link").href = "../signup/signup-page.html?org=" + org.organization_id;
  ...
  async function loadOrganizations() {
    try {
      allOrganizations = await window.ApiClient.marketplace.organizations();
      render();
    } catch (err) {
