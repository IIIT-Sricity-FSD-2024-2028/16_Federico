...
function renderBrandingPreview(uploadResult) {
  ...
  if (uploadResult.mimetype === 'application/pdf') {
    preview.innerHTML = `
      <div class="branding-placeholder">
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--admin-danger)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
          <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
          <polyline points="14 2 14 8 20 8"></polyline>
          <line x1="16" y1="13" x2="8" y2="13"></line>
          <line x1="16" y1="17" x2="8" y2="17"></line>
        </svg>
        <span style="color: var(--admin-danger); font-weight: 600;">PDF<br>uploaded</span>
      </div>`;
  } else {
  ...
  if (meta) {
    meta.innerHTML = `<span class="branding-meta-badge">✓ ${window.Formatters.escapeHtml(uploadResult.originalName)}</span> · ${formatFileSize(uploadResult.sizeBytes)} · uploaded just now`;
  }
}
