...
/**
 * In-memory data store — direct port of the NestJS `DataService`.
 * A `require()`'d module is cached by Node, so every file that requires
 * this module shares the same object reference (equivalent to the
 * `@Global() @Injectable()` singleton it replaces).
 */
const dataStore = {
  stateVersion: '3.0.0',
  ...
  // Section 5 — Billing
  services: [
    { service_id: 1, service_name: 'Consultation Fee', base_cost: 500.0 },
    { service_id: 2, service_name: 'Room Rent', base_cost: 5000.0 },
    { service_id: 3, service_name: 'Neurology Consultation', base_cost: 800.0 },
    { service_id: 4, service_name: 'EEG', base_cost: 2500.0 },
    { service_id: 5, service_name: 'CT Scan', base_cost: 6000.0 },
    { service_id: 6, service_name: 'MRI Brain', base_cost: 12000.0 },
    { service_id: 7, service_name: 'Blood Test', base_cost: 400.0 },
  ],
  ledgers: [],
  ledgerEntries: [],
  insurances: [],
